...
namespace NUnit_Project.Pages.Components.Profile
{
    public class SkilPage : CommonDriver
    {
        ...
        // POM methods
        public void SkillPage(SkillModel data)
        {
            // Go to Skill tab
            ...
            driver.FindElement(enterFirstSkill).SendKeys(data.Skill);
            ...
            selectElement1.SelectByText(data.Level);
        ...
        // GetlastSkill from the UI in form of text
        ...
        public void DeleteAllSkills(SkillModel data)
        {
        ...
        public void UpdateSkill(SkillModel data)
        {
            // Go to Skill tab
            driver.FindElement(skillTab).Click();
            // capture all rows 
            ...
            foreach (var row in rows)
            {
                ...
                if (skillCell.Text.Trim().Equals(data.OriginalSkill, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    skillInput.Clear();
                    skillInput.SendKeys(data.Skill);
